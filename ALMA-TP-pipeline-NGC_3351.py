...
path_galaxy = "tmp/2015.1.00956.S/2015.1.00956.S/science_goal.uid___A001_X2fb_X27b/group.uid___A001_X2fb_X27c/member.uid___A001_X2fb_X283/"
flag_file   = "fileflagNGC_3351.py"             # File containing additional flags 
...
source     = 'NGC_3351'                         # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '428~1128'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '540~1015'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 10h43m57s +11d42m14s'   # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 778                            # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
