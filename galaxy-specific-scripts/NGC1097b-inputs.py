...
# NGC 1097 subblock 1, i.e. NGC1097_d_06_TP

path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2895/group.uid___A001_X1284_X2896/member.uid___A001_X12a3_X54c/"
flag_file   = "NGC1097b-flagfile.py"             # File containing additional flags 
...
source     = 'NGC1097'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '771~1771'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '950~1550'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 02h46m19.0s -30d17m30s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1271                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
