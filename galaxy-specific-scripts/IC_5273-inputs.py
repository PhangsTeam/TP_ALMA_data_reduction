...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X28a9/group.uid___A001_X1284_X28aa/member.uid___A001_X1284_X28b1/"
flag_file   = IC5273-flagfile.py"             # File containing additional flags 
...
source     = 'IC5273'                           # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '793~1793'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '1093~1493'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 22h59m26.7s -37d42m10s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1293                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
EBexclude      = ['uid___A002_Xc8b2b0_X9359']
