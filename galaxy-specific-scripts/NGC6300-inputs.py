...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X12a3_X4b8/group.uid___A001_X12a3_X4b9/member.uid___A001_X12a3_X4be/"
flag_file   = "fileflagNGC_6300.py"             # File containing additional flags 
...
vel_line   = '900~1300'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 17h16m59.5s -62d49m14s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1109                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
