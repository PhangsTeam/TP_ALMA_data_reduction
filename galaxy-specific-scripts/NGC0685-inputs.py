...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X289f/group.uid___A001_X1284_X28a0/member.uid___A001_X1284_X28a7/" 
flag_file   = "fileflagNGC_0685.py"             # File containing additional flags 
...
source     = 'NGC0685'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '963~1763'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '1170~1425;1588~1655'              # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 01h47m42.8s -52d45m43s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1363                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
vwidth_kms     = 800                            # width in velocity and velocity resolution in km/s
chan_dv_kms    = 2.5
