...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2679/group.uid___A001_X1284_X267a/member.uid___A001_X12a3_X4c8/"
flag_file   = NGC5248-flagfile.py"             # File containing additional flags 
...
vel_cube   = '500~1800'                           # Range in velocity in km/s to extract the line cube.
vel_line   = '990~1330'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 13h37m33.8s +08d52m39s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
