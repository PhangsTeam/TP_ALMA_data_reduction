...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2665/group.uid___A001_X1284_X2666/member.uid___A001_X1284_X266d/" # should start with "tmp/" instead of the sequence of ".."
flag_file   = "NGC5530-flagfile.py"             # File containing additional flags
...
source     = 'NGC5530'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '493~1893'                        # Range in velocity in km/s to extract the line cube. Set to a range of 1000 centered on the source_vel_kms below
vel_line   = '843~1543'                       # Range in velocity in km/s to exclude the line emission from the baseline fit. Set to the central 500 km/s around source_vel_kms set below. Verify by looking at a spectrum of the galaxy
...
phase_center   = 'J2000 14h18m27.1s -43d23m19s'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1193                        # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
EBexclude      = ['uid___A002_Xc8b2b0_X66f0','uid___A002_Xc8b2b0_X5e65','uid___A002_Xc89480_Xddad','uid___A002_Xc89480_X4168','uid___A002_Xc89480_X3781','uid___A002_Xc8592e_X58f1','uid___A002_Xc8592e_X502b','uid___A002_Xc845c0_Xb7ca']
