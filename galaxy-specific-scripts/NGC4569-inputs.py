...
# NGC 4569 (NGC4569_a_06_TP)

path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X12a3_X4ee/group.uid___A001_X12a3_X4ef/member.uid___A001_X12a3_X4f4/"
flag_file   = "NGC4569-flagfile.py"             # File containing additional flags
...
source     = 'NGC4569'                         # Source name (without a/b/c)
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '-735~265'                        # Range in velocity in km/s to extract the line cube. Set to a range of 1000 centered on the source_vel_kms below
vel_line   = '-470~0'                       # Range in velocity in km/s to exclude the line emission from the baseline fit. Set to the central ~500 km/s around source_vel_kms set below. Verify by looking at a spectrum of the galaxy
...
phase_center   = 'J2000 12h36m49.8s +13d09m47'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = -235                        # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
