...
path_galaxy = "tmp/2015.1.00956.S/science_goal.uid___A001_X2fb_X2d5/group.uid___A001_X2fb_X2d6/member.uid___A001_X2fb_X2dd/"
flag_file   = NGC6744a-flagfile.py"             # File containing additional flags 
...
source     = 'NGC6744'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '591~1091'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '780~1010'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 19h09m46.1s -63d49m34.1'# Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 841                            # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
name_line      = 'north.CO21'                   # Name of the line, to be used for naming the files

# Exclude these EBe, SEMIPASS and the 2nd one doesn't have JyperK convertion factor information.
EBexclude      = ['uid___A002_Xb68dbd_X605','uid___A002_Xb3e112_Xb94']
