...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2697/group.uid___A001_X1284_X2698/member.uid___A001_X1284_X269f/"
flag_file   = NGC4951-flagfile.py"             # File containing additional flags 
...
source     = 'NGC4951'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '876~1476'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '1040~1370'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 13h05m07.7s -06d29m38s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1176                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
#wo3EBs
# Exclude these EBs, Sno JyperK conversion
