...
# NGC 5248 subblock 2, i.e. NGC5248_c_06_TP

path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X266f/group.uid___A001_X1284_X2670/member.uid___A001_X12a3_X4c6/"
flag_file   = "NGC5248a-flagfile.py"             # File containing additional flags
...
source     = 'NGC5248'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '651~1651'                        # Range in velocity in km/s to extract the line cube. Set to a range of 1000 centered on the source_vel_kms below
vel_line   = '901~1401'                        # Range in velocity in km/s to exclude the line emission from the baseline fit. Set to the central 500 km/s around source_vel_kms set below. Verify by looking at a spectrum of the galaxy
...
phase_center   = 'J2000 13h37m29.5s +08d53m49'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1151                          # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
