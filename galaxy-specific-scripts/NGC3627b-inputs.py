...
path_galaxy  = "tmp/2015.1.00956.S/science_goal.uid___A001_X2fb_X28f/group.uid___A001_X2fb_X290/member.uid___A001_X2fb_X297/"
path_galaxy2 = "tmp/2015.1.00956.S/science_goal.uid___A001_X2fb_X285/group.uid___A001_X2fb_X286/member.uid___A001_X2fb_X28d/"
flag_file    = NGC3627b-flagfile.py"             # File containing additional flags 
...
source     = 'NGC_3627'                         # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '377~1077'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '495~950'                          # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 11h20m14.9s +12d59m30'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 727                            # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
name_line      = 'CO21_both'                    # Name of the line, to be used for naming the files
