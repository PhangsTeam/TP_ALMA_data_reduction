...
# NGC 4826 (NGC4826_a_06_TP)

path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X12a3_X4d2/group.uid___A001_X12a3_X4d3/member.uid___A001_X12a3_X4d8/"
flag_file   = "fileflagNGC_4826.py"             # File containing additional flags
...
source     = 'NGC4826'                         # Source name (without a/b/c)
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '-92~908'                        # Range in velocity in km/s to extract the line cube. Set to a range of 1000 centered on the source_vel_kms below
vel_line   = '158~658'                       # Range in velocity in km/s to exclude the line emission from the baseline fit. Set to the central 500 km/s around source_vel_kms set below. Verify by looking at a spectrum of the galaxy
...
phase_center   = 'J2000 12h56m43.6s +21d40m59'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 408                        # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
