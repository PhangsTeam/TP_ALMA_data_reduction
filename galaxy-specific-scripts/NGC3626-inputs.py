...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2769/group.uid___A001_X1284_X276a/member.uid___A001_X1284_X2771/"
flag_file   = "fileflagNGC_3626.py"             # File containing additional flags 
...
source     = 'NGC3626'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '980~1910'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1180~1710'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 11h20m03.8s +18d21m25s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1462                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
vwidth_kms     = 920                            # width in velocity and velocity resolution in km/s
chan_dv_kms    = 2.5
