...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2651/group.uid___A001_X1284_X2652/member.uid___A001_X1284_X2659/"
flag_file   = "fileflagNGC_5643.py"             # File containing additional flags 
...
source     = 'NGC5643'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '849~1549'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '1058~1344'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 14h32m40.7s -44d10m28s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1199                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
name_line      = 'CO21.a'                       # Name of the line, to be used for naming the files
#
# Exclude these EBs, SEMIPASS
EBexclude      = ['uid___A002_Xc8592e_Xb0e2','uid___A002_Xc8d560_X5e7e','uid___A002_Xc8ed16_X4f7a','uid___A002_Xc94c38_X4824','uid___A002_Xc94c38_Xd8d2','uid___A002_Xc94c38_Xe2ae','uid___A002_Xc96463_X4880','uid___A002_Xc96463_X51fc','uid___A002_Xc96463_X5970','uid___A002_Xc96f17_X4456','uid___A002_Xc96f17_X5552']
#-----------------------------------------------
