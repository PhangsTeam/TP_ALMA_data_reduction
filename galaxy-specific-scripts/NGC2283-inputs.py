...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2827/group.uid___A001_X1284_X2828/member.uid___A001_X1284_X282f/"
flag_file   = IC1809-flagfile.py"             # File containing additional flags 
...
source     = 'NGC2283'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '591~1191'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '710~935;1150~1242'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 06h45m52.7s -18d12m37s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
