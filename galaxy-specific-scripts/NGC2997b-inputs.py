...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X27e1/group.uid___A001_X1284_X27e2/member.uid___A001_X12a3_X528/" 
flag_file   = NGC2997-flagfile.py"             # File containing additional flags 
...
vel_line   = '910~1290'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 09h45m38.8s -31d11m28s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
