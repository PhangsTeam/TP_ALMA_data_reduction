...
# NGC 3521 subblock 1 (NGC3521_d_06_TP)

path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X279b/group.uid___A001_X1284_X279c/member.uid___A001_X12a3_X51a/"
flag_file   = "NGC3521b-flagfile.py"             # File containing additional flags
...
source     = 'NGC3521'                         # Source name (without a/b/c)
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '301~1301'                        # Range in velocity in km/s to extract the line cube. Set to a range of 1000 centered on the source_vel_kms below
vel_line   = '551~1051'                       # Range in velocity in km/s to exclude the line emission from the baseline fit. Set to the central 500 km/s around source_vel_kms set below. Verify by looking at a spectrum of the galaxy
...
phase_center   = 'J2000 11h05m47.1s -00d01m03'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 801                        # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
# EBs to exclude: none, all 7 successful according to tracker
EBexclude      = []
