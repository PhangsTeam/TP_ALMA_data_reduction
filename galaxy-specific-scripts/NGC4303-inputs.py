...
path_galaxy = "tmp/2015.1.00956.S/science_goal.uid___A001_X2fb_X2ad/group.uid___A001_X2fb_X2ae/member.uid___A001_X2fb_X2b5/"
flag_file   = NGC4303-flagfile.py"             # File containing additional flags 
...
source     = 'NGC4303'                         # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1306~1826'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1450~1720'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h21m54.9s +04d28m25'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1566                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
