...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X26d3/group.uid___A001_X1284_X26d4/member.uid___A001_X12a3_X4e0/"
flag_file   = NGC4689-flagfile.py"             # File containing additional flags 
...
source     = 'NGC4689'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1200~2000'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1200~1390;1505~1740'              # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h47m45.5s +13d45m46s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1616                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
