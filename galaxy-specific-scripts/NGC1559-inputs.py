...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2863/group.uid___A001_X1284_X2864/member.uid___A001_X12a3_X542/"
flag_file   = "fileflagNGC_1559.py"             # File containing additional flags 
...
source     = 'NGC1559'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '904~1704'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '1095~1466'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 04h17m35.8s -62d47m01s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1304                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
vwidth_kms     = 800 #1000                      # width in velocity and velocity resolution in km/s
chan_dv_kms    = 2.5
...
#EBexclude      = ['uid___A002_Xc8d560_X50e9','uid___A002_Xc8ed16_X4550','uid___A002_Xc8ed16_Xc8f5','uid___A002_Xce3de5_X27b']
#-----------------------------------------------
