...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X270f/group.uid___A001_X1284_X2710/member.uid___A001_X1284_X2717/"
flag_file   = NGC4540-flagfile.py"             # File containing additional flags 
...
source     = 'NGC4540'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1041~1541'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1200~1370'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h34m50.9s +15d33m06s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1291                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
