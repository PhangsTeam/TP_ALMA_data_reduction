...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X27af/group.uid___A001_X1284_X27b0/member.uid___A001_X12a3_X51e/"
flag_file   = "NGC3057-flagfile.py"             # File containing additional flag
...
source     = 'NGC3507'                         # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '479~1479'                        # Range in velocity in km/s to extract the line cube.
#vel_line   = '729~1229' ORIGINAL VALUE        # Range in velocity in km/s to exclude the line emission from the baseline fit.
vel_line   = '875~1075; 1200~1300'  # updated to exclude atm line
...
phase_center   = 'J2000 11h03m25.3s +18d08m08s'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 979                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
vwidth_kms     = 700                            # width in velocity and velocity resolution in km/s (updated from 500 km/s)
chan_dv_kms    = 2.5
