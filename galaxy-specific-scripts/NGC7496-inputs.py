...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2633/group.uid___A001_X1284_X2634/member.uid___A001_X1284_X263b/"
flag_file   = "fileflagNGC_7496.py"             # File containing additional flags 
...
source     = 'NGC7496'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1149~2149'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1149~1350;1515~1760'              # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 23h09m47.3s -43d25m41s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1649                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
vwidth_kms     = 600                            # width in velocity and velocity resolution in km/s
chan_dv_kms    = 2.5
...
#EBexclude      = ['uid___A002_Xcda49e_Xb4e0']
#-----------------------------------------------
