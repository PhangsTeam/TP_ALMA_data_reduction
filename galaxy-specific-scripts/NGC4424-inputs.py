...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2741/group.uid___A001_X1284_X2742/member.uid___A001_X1284_X2749/"
flag_file   = NGC4424-flagfile.py"             # File containing additional flags 
...
source     = 'NGC4424'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '170~690'                          # Range in velocity in km/s to extract the line cube.
vel_line   = '330~540'                          # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h27m11.6s +09d25m14s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 437                            # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
