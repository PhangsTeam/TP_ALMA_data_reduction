...
# NGC 3521 subblock 2 (NGC3521_c_06_TP)

path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2791/group.uid___A001_X1284_X2792/member.uid___A001_X12a3_X518/"
flag_file   = "NGC3521a-flagfile.py"             # File containing additional flags
...
phase_center   = 'J2000 11h05m50.3s -00d03m15ss'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
