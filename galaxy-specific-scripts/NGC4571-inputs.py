...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X26f1/group.uid___A001_X1284_X26f2/member.uid___A001_X12a3_X4ec/"
flag_file   = "NGC4571-flagfile.py"             # File containing additional flags
...
source     = 'NGC4571'                         # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '-158~842'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '220~450'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h36m56.4s +14d13m02s'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 342                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
vwidth_kms     = 700                            # width in velocity and velocity resolution in km/s (increased from 500 km/s)
chan_dv_kms    = 2.5
...
# EBs to exclude - first 3 semipass, next 2 had no line visible
EBexclude      = ['uid___A002_Xcb7a9d_X1f2d','uid___A002_Xcb5bc7_X9949','uid___A002_Xcb5bc7_X8991','uid___A002_Xcb402e_X1b48','uid___A002_Xcb402e_Xf75']  
