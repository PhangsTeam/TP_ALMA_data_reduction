...
path_galaxy = "tmp/2015.1.00956.S/science_goal.uid___A001_X2fb_X2df/group.uid___A001_X2fb_X2e0/member.uid___A001_X2fb_X2e7/"
flag_file   = "fileflagNGC_6744b.py"             # File containing additional flags 
...
vel_line   = '650~900'                          # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 19h09m46.1s -63d53m21.8'# Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
...
name_line      = 'south.CO21'                   # Name of the line, to be used for naming the files
