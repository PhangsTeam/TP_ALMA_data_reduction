...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X281d/group.uid___A001_X1284_X281e/member.uid___A001_X1284_X2825/"
flag_file   = "fileflagNGC_2566.py"             # File containing additional flags 
...
source     = 'NGC2566'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1287~1987'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1287~1337;1437~1837'              # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 08h18m45.6s -25d29m58s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1637                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
