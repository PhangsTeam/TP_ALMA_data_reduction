...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X26b5/group.uid___A001_X1284_X26b6/member.uid___A001_X12a3_X4da/"
flag_file   = "fileflagNGC_4781.py"             # File containing additional flags 
...
source     = 'NGC4781'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '910~1610'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '1129~1396'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h54m23.7s -10d32m14s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1260                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
EBexclude      = ['uid___A002_Xcf3a9c_X9de']
#-----------------------------------------------
