...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X26bf/group.uid___A001_X1284_X26c0/member.uid___A001_X12a3_X4dc/"
flag_file   = "fileflagNGC_4731.py"             # File containing additional flags 
...
source     = 'NGC4731'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1089~1889'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1089~1290;1370~1590'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h51m01.1s -06d23m35s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1489                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
EBexclude      = ['uid___A002_Xca9e6b_Xc097']
#-----------------------------------------------
