...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X2683/group.uid___A001_X1284_X2684/member.uid___A001_X1284_X268b/"
flag_file   = "fileflagNGC_5134.py"             # File containing additional flags 
...
source     = 'NGC5134'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1358~2158'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1675~1840'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 13h25m18.5s -21d08m03s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1758                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
