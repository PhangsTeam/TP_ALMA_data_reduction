...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X26c9/group.uid___A001_X1284_X26ca/member.uid___A001_X1284_X26d1/" 
flag_file   = "fileflagNGC_4694.py"             # File containing additional flags 
...
source     = 'NGC4694'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '760~1560'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '960~1360'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h48m15.1s +10d59m01s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1160                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
