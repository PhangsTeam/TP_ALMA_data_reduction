...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X268d/group.uid___A001_X1284_X268e/member.uid___A001_X12a3_X4cc/"
flag_file   = "fileflagNGC_5042.py"             # File containing additional flags 
...
source     = 'NGC5042'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1040~1740'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1270~1510'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 13h15m31.0s -23d59m03s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1390                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
EBexclude      = ['uid___A002_Xca9e6b_Xc691','uid___A002_Xce2ffa_X2760','uid___A002_Xcb053b_X41f5','uid___A002_Xce2ffa_X3091','uid___A002_Xce8d43_Xd58']
#-----------------------------------------------
