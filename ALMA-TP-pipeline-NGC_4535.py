...
path_galaxy = "tmp/2015.1.00956.S/science_goal.uid___A001_X2fb_X2cb/group.uid___A001_X2fb_X2cc/member.uid___A001_X2fb_X2d3/"
flag_file   = "fileflagNGC_4535.py"             # File containing additional flags 
...
source     = 'NGC_4535'                         # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '1620~2320'                        # Range in velocity in km/s to extract the line cube.
vel_line   = '1740~2200'                        # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 12h34m20.3s +08d11m52'  # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1970                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
vwidth_kms     = 500 #700                       # width in velocity and velocity resolution in km/s
chan_dv_kms    = 2.5
...
EBexclude      = ['uid___A002_Xb1e6b5_X30d1']  
