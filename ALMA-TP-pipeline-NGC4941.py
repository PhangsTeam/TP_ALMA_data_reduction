...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X26a1/group.uid___A001_X1284_X26a2/member.uid___A001_X12a3_X4d0/"
flag_file   = "fileflagNGC_4941.py"             # File containing additional flags 
...
source     = 'NGC4941'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '608~1608'                         # Range in velocity in km/s to extract the line cube.
vel_line   = '945~1290'                         # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 13h04m13.1s -05d33m06s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
source_vel_kms = 1108                           # Provide velocity of the source, otherwise set to "False" and coordinates will be read from the data
...
EBexclude      = ['uid___A002_Xcaca82_X1e2f','uid___A002_Xcaca82_X25cc','uid___A002_Xcad526_X4473','uid___A002_Xcad526_X4f18','uid___A002_Xcaf094_X15e5','uid___A002_Xceb911_X1624','uid___A002_Xcef406_X1b26']
#-----------------------------------------------
