...
path_galaxy = "tmp/2017.1.00886.L/science_goal.uid___A001_X1284_X27f5/group.uid___A001_X1284_X27f6/member.uid___A001_X1284_X27fd/"
...
source     = 'NGC2903'                          # Source name
freq_rest  =  230538.                           # Rest frequency of requested line in MHz (ex: "freq_rest  = 230538" for CO(2-1))
vel_cube   = '50~1050'                          # Range in velocity in km/s to extract the line cube.
vel_line   = '390~780'                          # Range in velocity in km/s to exclude the line emission from the baseline fit.
...
phase_center   = 'J2000 09h32m09.8s +21d30m12s' # Provide coordinate of phase center, otherwise set to "False" and coordinates will be read from the data
